      ...
      <div className="flex flex-col lg:flex-row items-center gap-16">
        ...
        <div className="w-full lg:w-1/2 relative group perspective-1000">
          <div className="relative aspect-[3/4] w-full max-w-md mx-auto rounded-[2.5rem] overflow-hidden border border-white/10 shadow-[0_30px_60px_rgba(220,38,38,0.15)] transition-all duration-700 group-hover:shadow-[0_40px_80px_rgba(220,38,38,0.3)] group-hover:-translate-y-2">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-80 transition-opacity duration-500 group-hover:opacity-60"></div>
          </div>
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-start text-left z-10">
          ...
          <Link
            href={`/${locale}/aboutus`}
            className="px-8 py-4 bg-red-600 hover:bg-red-700 text-white font-bold rounded-2xl transition-all duration-300 shadow-[0_0_25px_rgba(220,38,38,0.4)] hover:shadow-[0_0_40px_rgba(220,38,38,0.7)] hover:-translate-y-1 flex items-center gap-3"
          >
