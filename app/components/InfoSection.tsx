    ...
    <section className="py-24 px-6 max-w-7xl mx-auto overflow-hidden">
      <div className="flex flex-col lg:flex-row items-center gap-16">
        ...
        <div className="w-full lg:w-1/2 relative group perspective-1000">
          <div className="relative aspect-[3/4] w-full max-w-md mx-auto rounded-[2.5rem] overflow-hidden border border-white/10 shadow-[0_30px_60px_rgba(37,99,235,0.15)] transition-all duration-700 group-hover:shadow-[0_40px_80px_rgba(37,99,235,0.3)] group-hover:-translate-y-2">
          ...
          <div className="absolute -bottom-8 -right-8 w-40 h-40 bg-blue-600/20 blur-3xl rounded-full pointer-events-none"></div>
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-start text-start z-10">
          ...
          <h3 className="text-xl md:text-2xl text-blue-400 font-semibold mb-6">
            {t('subtitle')}
          </h3>
          ...
          {/* الكروت مع إضاءة وتوهج أزرق فخم */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10 w-full max-w-xl">
            <div className="flex items-center gap-3 p-4 rounded-2xl bg-zinc-900/80 border border-blue-600/40 backdrop-blur-sm shadow-[0_0_20px_rgba(37,99,235,0.2)] hover:shadow-[0_0_30px_rgba(37,99,235,0.4)] hover:border-blue-500 transition-all duration-300">
