...
export default function Footer() {
  ...
  return (
    <footer 
      className="relative w-full overflow-hidden bg-black/70 backdrop-blur-2xl border-t-2 border-blue-600/50 shadow-[0_-15px_50px_rgba(37,99,235,0.15)] mt-20"
      dir={isRtl ? 'rtl' : 'ltr'}
    >
      ...
      <div className="max-w-7xl mx-auto px-6 pt-16 pb-8 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center gap-10 mb-12">
          ...
          <div className="flex items-center gap-4">
            <div className="relative w-20 h-20 drop-shadow-[0_0_15px_rgba(37,99,235,0.5)]">
              <Image 
                src="/logoo.webp" 
        ...
        <div className="w-full h-px bg-gradient-to-r from-transparent via-blue-600/40 to-transparent mb-12" />

        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          
          <div>
            <h3 className="text-xl font-bold text-white mb-6 border-b border-blue-600/30 pb-3 inline-block drop-shadow-[0_0_10px_rgba(37,99,235,0.6)]">
              {t('quickLinksTitle')}
            </h3>
